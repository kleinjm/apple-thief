...
class BagsControllerTest < ActionController::TestCase
  ...
  test "should create bag" do
    assert_difference('Bag.count') do
      post :create, bag: { capacity: @bag.capacity, description: @bag.description, name: @bag.name, photo_url: @bag.photo_url }
    end
  ...
  test "should update bag" do
    put :update, id: @bag, bag: { capacity: @bag.capacity, description: @bag.description, name: @bag.name, photo_url: @bag.photo_url }
    assert_redirected_to bag_path(assigns(:bag))
  end
